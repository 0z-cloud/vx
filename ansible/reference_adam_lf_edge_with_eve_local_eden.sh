#!/bin/bash
################################################################################
SCRIPT_NAME="reference_lf_local_eden.sh"
PIPELINE_NAME="reference_lf_local_eden.sh - Local Copy of Country of 0z where Wizard do Miracle at place for you, relax and enjoy"
################################################################################
inventory="$1"
product="$2"
username="$3"
