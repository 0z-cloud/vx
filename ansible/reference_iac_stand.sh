#!/bin/bash
################################################################################
SCRIPT_NAME="reference_iac_stand.sh"
PIPELINE_NAME="DevOps IaC 0 level Bootstrap Landscape Only. If you not DevOps and run it you will be killed by DevOps team."
################################################################################
inventory="$1"
product="$2"
username="$3"
