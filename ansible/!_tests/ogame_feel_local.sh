...
. $ansible_dir/\!_tests/ogame_env.sh '$linked_env_in_product' '$run_choise_one_button_happy_place'
...
echo "passed_ci_docker_tag_ogame_php: latest" >> $LOCAL_DIRECTORY/current_tags.yml
