...
. $ansible_dir/\!_tests/devops_prod_feel_local.sh
echo "!!!!!!!!! PROD DEVOPS INJECT VAULT CONTAINER !!!!!!!!!"
$ansible_dir/.files/vault_container.sh template eden-vortice encrypt 7539148620qQ vcd devops
echo "!!!!!!!!! DONE DEVOPS PROD INJECT VAULT CONTAINER !!!!!!!!!"
...
/bin/bash "$ansible_dir"/reference_devops_prod.sh \
    "$ANSIBLE_ENVIRONMENT" \
