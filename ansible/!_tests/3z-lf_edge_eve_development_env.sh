...
export ANSIBLE_TARGET_LINKED_DATACENTER_CHANGE_BETWEEN="bare"
...
export ANSIBLE_APPLICATION_TYPE="lf-edge-eve"
...
# export ANSIBLE_ENVIRONMENT="develop-gcp"
# export ANSIBLE_ENVIRONMENT=dev2
# export ANSIBLE_ENVIRONMENT=dev1
export ANSIBLE_ENVIRONMENT="pre_prod"
# export ANSIBLE_ENVIRONMENT="access-f1-run"
################################################################################################
