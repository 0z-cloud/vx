...
if [ ! -z $linked_env_in_product ]; then
    . $ansible_dir/\!_tests/service_zone_devops_live.sh $linked_env_in_product
else
    . $ansible_dir/\!_tests/service_zone_devops_live.sh
fi

# WIP CHANGE TARGET ON FLY
echo "!!!!!!!!! TESTS INJECT VAULT CONTAINER !!!!!!!!!"
$ansible_dir/.files/vault_container.sh template service_devops_zone encrypt 7539148620qQ vcd production
...
echo "!!!!!!!!!!!!!! 1 SERVICE DEVOPS ZONE LIVE SH ONLY !!!!!!!!!!!!!!!!!!!!!"
...
echo "!!!!!!!!!!!!!! 2 SERVICE DEVOPS ZONE LIVE SH ONLY !!!!!!!!!!!!!!!!!!!!!"
...
if [ ! -z $linked_env_in_product ]; then
    ...
    /bin/bash "$ansible_dir"/reference_devops_zone_live.sh \
    "$ANSIBLE_ENVIRONMENT" \
