...
if [ ! -z $linked_env_in_product ]; then
    . $ansible_dir/\!_tests/development_feel_local.sh $linked_env_in_product
else
    . $ansible_dir/\!_tests/development_feel_local.sh
fi
...
echo "!!!!!!!!!!!!!! RND DEVELOPMENT MATRESHKA 911RS ONLY ZONE !!!!!!!!!!!!!!!!!!!!!"
