...
echo "!!!!!!!!!!!!!! 1 APPLICATION SET SOLUTION FROM SERVICES FOLDERSTAGE ZONE LIVE SH ONLY !!!!!!!!!!!!!!!!!!!!!"
...
echo "!!!!!!!!!!!!!! 2 APPLICATION SET SOLUTION FROM SERVICES FOLDERSTAGE ZONE LIVE SH ONLY !!!!!!!!!!!!!!!!!!!!!"

if [ ! -z $linked_env_in_product ]; then

    echo "!!!!!!!!!!!!!! 2 target $linked_env_in_product ZONE LIVE SH ONLY !!!!!!!!!!!!!!!!!!!!!"

    /bin/bash "$ansible_dir"/reference_adam_zone.sh \
    "$ANSIBLE_ENVIRONMENT" \
