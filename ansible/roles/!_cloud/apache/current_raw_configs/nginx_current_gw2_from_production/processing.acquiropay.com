...
server {
	listen   10.1.1.252:443; 							# https://processing.vortex.com
        #listen   10.1.1.191:443; ## listen for ipv4; this line is default and implied  # https://processing.vortex.com:444
	...
	access_log /var/log/nginx/processing.vortex.com.com.access.log main;
	error_log /var/log/nginx/processing.vortex.com.com.error.log;
        location / {
