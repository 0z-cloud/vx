...
When run against a specific host, this script returns the following variables:
 ...
 - ec2_image_id
 - ec2_instanceState
 - ec2_anycloud_virtual_machine_resources_primary_type
 - ec2_ipOwnerId
 - ec2_ip_address
 - ec2_item
 - ec2_kernel
...
class Ec2Inventory(object):
    ...
    def read_settings(self):
        ...
        group_by_options = [
            ...
            'group_by_ami_id',
            'group_by_anycloud_virtual_machine_resources_primary_type',
            'group_by_key_pair',
            'group_by_vpc_id',
    ...
    def add_instance(self, instance, region):
        ...
        if self.group_by_anycloud_virtual_machine_resources_primary_type:
            type_name = self.to_safe('type_' + instance.anycloud_virtual_machine_resources_primary_type)
    ...
    def add_elasticache_cluster(self, cluster, region):
        ...
        if self.group_by_anycloud_virtual_machine_resources_primary_type and not is_redis:
