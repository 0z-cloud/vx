#!/bin/bash
################################################################################
SCRIPT_NAME="reference_example_product_at_service_web_zone.sh"
PIPELINE_NAME="reference_example_product_at_service_web_zone If you not DevOps and run it you will be killed by DevOps team."
################################################################################
inventory="$1"
product="$2"
username="$3"
