#!/bin/bash
################################################################################
SCRIPT_NAME="reference_devops_prod.sh"
PIPELINE_NAME="DevOps Production Only. If you not DevOps and run it you will be killed by DevOps team."
################################################################################
inventory="$1"
product="$2"
username="$3"
...
# GO INFRA PHASE I
devops_prod_run_bootstrap_and_check_infra "$typeofcloud" "$ansible_dir" "$product" "$inventory";
