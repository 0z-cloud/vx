...
from ansible.module_utils.utils import get_compute_policy_tags
...
class VApp(object):
    ...
    def update_self_any_spec(self, replace_item):
        self.update(spec)

    def update_to_sourced_item(self, spec):
        """Update a any SourcedItem from a vm specification.
        ...
        needs_customization = 'disk_size' in spec or 'password' in spec or 'custom_script' in spec or \
        ...
        update_self_any_spec(self.sourced_item, replace_item)
    ...
    def create_vapp_network(self,
        ...
        config.append(E.GuestVlanAllowed(is_guest_vx_vlan_allowed))
    ...
    def update_vm_guest_customization_item(self, spec):
        """Creates a vm SourcedItem from a vm specification.
