...
class VDC(object):
    ...
    def create_routed_vdc_network(self,
        ...
        :param bool guest_vx_vlan_allowed: True if Network allows guest VLAN
                                        tagging
        ...
        if guest_vx_vlan_allowed is not None:
            vdc_network_configuration.append(
                E.GuestVlanAllowed(guest_vx_vlan_allowed))
