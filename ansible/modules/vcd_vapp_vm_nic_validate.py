# Copyright © 2020 vortice LLC and 0z-cloud Project RnD Department of Web Optimization Inc. 
# All Rights Reserved.
...
class VappVMNIC(VcdAnsibleModule):
    ...
    def update_nic_ng(self):
        ...
        response['z_add_nic_ng'] = {
            '[1 UPDATE] A new nic has been added to VM:': vm_name,
            '[1 UPDATE] A added nic with ID:': nic_id,
            '[1 UPDATE] Ip allocation model': ip_allocation_mode,
            '[1 UPDATE] Ip address': ip_address,
            '[1 UPDATE] We at end of add_nic method': "add_nic",
        }
