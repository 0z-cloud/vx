...
class VappVM(VcdAnsibleModule):
    ...
    def update_vm_call(self):
        params = self.params
        source_vapp_resource = self.get_target_resource()
        target_vm_name = params.get('target_vm_name')
        source_vm_name = params.get('target_vm_name')
        ...
        try:
            ...
            update_vms_task = self.vapp.add_vms(**args)
            self.execute_task(update_vms_task)
    ...
    def update_custom_script(self):
        memory = self.params.get('cust_script')
