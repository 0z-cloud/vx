#!/bin/bash
################################################################################
SCRIPT_NAME="reference_911rs-wo-0z-cloud.sh"
PIPELINE_NAME="reference_911rs-wo-0z-cloud.sh - Local Wo o)z-cloud ecosystem bootsrap are you like in Country of 0z where Wizard do Miracle at place for you, relax and enjoy"
################################################################################
inventory="$1"
product="$2"
username="$3"
