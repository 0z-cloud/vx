#!/bin/bash
################################################################################
SCRIPT_NAME="reference_0z-eve-cloud.sh"
PIPELINE_NAME="reference_0z-eve-cloud.sh - Local o)z-eve-cloud ecosystem bootsrap are you like in Country of 0z where Wizard do Miracle at place for you, relax and enjoy"
################################################################################
inventory="$1"
product="$2"
username="$3"
