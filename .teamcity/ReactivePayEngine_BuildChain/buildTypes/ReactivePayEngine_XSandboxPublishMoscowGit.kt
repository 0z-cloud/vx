...
object ReactivePayEngine_XSandboxPublishMoscowGit : BuildType({
    ...
    params {
        ...
        param("ANSIBLE_REGISTRY_USERNAME", "teamcity")
        param("ANSIBLE_CI_PROJECT_NAME", "eden-vertice")
        text("ANSIBLE_TRIGGER_TOKEN", "ZQzkrRjHiz_C1hhkosmW", allowEmpty = true)
        param("main_build_id", "${ReactivePay_Main.depParamRefs["build.counter"]}")
