...
object CryptoBank_BuildChain_4frontUpdateNginxFrontendDnsBackend : BuildType({
    ...
    dependencies {
        ...
        snapshot(CryptoBank_BuildChain_3deployPublicationToInfrastructure) {
            onDependencyFailure = FailureAction.FAIL_TO_START
        }
        dependency(CryptoBank_BuildChain_PrepareCi) {
            snapshot {
                onDependencyFailure = FailureAction.FAIL_TO_START
            }
